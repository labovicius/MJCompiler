...
public class MulopFactorCho extends MulopFactorCh {

    private MulopFactorCh MulopFactorCh;
    private Mulop Mulop;
    private Factor Factor;

    public MulopFactorCho (MulopFactorCh MulopFactorCh, Mulop Mulop, Factor Factor) {
